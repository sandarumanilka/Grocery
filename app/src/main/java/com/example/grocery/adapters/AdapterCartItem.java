    ...
    public void onBindViewHolder(@NonNull HolderCartItem holder, final int position) {
        ...
        holder.itemRemoveTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                double tx = Double.parseDouble((((shopDetailsActivity)context).allTotalPriceTv.getText().toString().trim().replace("LKR","")));
                double totalPrice = tx - Double.parseDouble(cost.replace("LKR",""));
                double deliveryFee = Double.parseDouble((((shopDetailsActivity)context).deliveryFee.replace("LKR","")));
